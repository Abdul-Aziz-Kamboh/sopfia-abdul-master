...
import com.outstarttech.kabir.property.activities.ocr.CaptureActivity;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class AlgebraCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algebra_calculator);
...
//        getSupportActionBar().setLogo(R.drawable.logoactionbar);
            getSupportActionBar().setTitle("Algebra Calculator");
        }

        solveeq = (Button) findViewById(R.id.solve);

        solveeq.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(AlgebraCalculator.this)
                .setMessage(message)
...
//            createInformationDialog();
    ...
    public void displaySteps(String solution, String step, String content) {
        ...
        stepTextView.setTextColor(Color.parseColor("#00FFFF"));
        stepContentTextView.setTextColor(Color.parseColor("#00FFFF"));
        solutionTextView.setTextColor(Color.parseColor("#FF00FF"));
